...
// Custom bootstrap: keep #flutter-loading visible until first frame (and a short minimum time).
...
(function () {
  ...
  _flutter.loader.load({
    serviceWorkerSettings: {
      serviceWorkerVersion: "3982448032" /* Flutter's service worker is deprecated and will be removed in a future Flutter release. */,
    },
    onEntrypointLoaded: async function (engineInitializer) {
      ...
      const firstFramePromise = new Promise(function (resolve) {
        ...
        function afterFirstFrame() {
          ...
          function tick() {
            if (performance.now() - start >= minMsAfterFirstFrame) {
              done();
            } else {
